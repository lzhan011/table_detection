...
def get_available_gpus():
    ...
    #     print("x.name:",x.name)
    #     print("x.device_type:",x.device_type)
...
print(FLAGS.gpu)
device_result = get_available_gpus()
...
def main(args):
   ...
   # Defines {FLAGS.train_dir}, maybe based on {FLAGS.experiment_dir}
    ...
    if FLAGS.mode == "train":
        ...
        print("FLAGS.validation_dataset_file_path")
        print(FLAGS.validation_dataset_file_path)
        print(len(FLAGS.validation_dataset_file_path) != 0)
        # exit()
